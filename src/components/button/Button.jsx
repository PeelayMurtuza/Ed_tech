    ...
    return (
        <div>
            <div className="flex gap-3 ">
                ...
                <div className="btn1 w-36 h-10 bg-gray-950 text-white font-bold text-[14px] flex justify-center items-center rounded-xl hover:scale-90 transition-all delay-100   ">Book a Demo</div>
